...
1. Issue references in the commit messages (`#123`, `Closes #45`, GitLab `!67`, etc.) — fetch via the configured backend (`/tracker-notion`, or the recipe in `docs/agents/issue-tracker.md`).
