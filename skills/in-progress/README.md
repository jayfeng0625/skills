...
- **[grilling](./grilling/SKILL.md)** — Upstream's standalone "interview relentlessly" loop. Not yet adopted — our `grill-me` / `grill-with-docs` are self-contained — so parked here pending a decision to refactor onto it.
