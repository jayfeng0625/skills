# Verify/Check Mode for `setup-bonai-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-bonai-skills`.
...
- #106 — Feature request: verify/check mode for setup-bonai-skills
